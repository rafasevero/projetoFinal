    ...
    public function updateExperience(Request $request, $id)
{
    ...
    // Recupera a experiência profissional do usuário
    $professionalExperience = Professional_experiences::where('id', $id)
        ->where('user_id', $user->id)
        ->first();

    // Verifica se a experiência profissional foi encontrada
